...
import { BookOpen, Download, Eye, Plus, X } from "lucide-react";
import {
  Card,
  CardHeader,
  CardTitle,
...
import TopicContentService from "@/services/Admin_Service/Topic_Content_service"; // Make sure this path matches your project
import Topic from "../Interfaces/Topic_Interface"; // Update with the actual location of your `Topic` interface
                ...
                <div className="text-center py-24 px-4">
                  <div className="bg-white rounded-xl shadow-sm p-12 max-w-2xl mx-auto">
                    ...
                    <Button className="bg-green-700 hover:bg-green-800 text-white px-6">
                      <Plus size={18} className="mr-2" /> Add Your First Content
                    </Button>
                  </div>
                </div>
              )}
