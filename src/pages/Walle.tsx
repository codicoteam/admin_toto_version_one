...
>
        ...
        <div className="flex w-full mb-2 px-2">
          ...
          <div className="flex items-center p-2 mx-1 flex-1">
            ...
            <div>
              <p className="text-slate-900 font-bold text-lg">$5000<sup className="text-red-600 text-xs"></sup></p>
              <p className="text-sm text-gray-700">Withdrawal</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row px-4 gap-4">
          ...
          <div className="bg-gray-100 p-4 rounded-md w-7/12">
            ...
            <div className="mb-16">
              ...
              <div className="h-20"></div> {/* Empty space for transactions */}
            </div>
          ...
          <div className="w-5/12 flex flex-col gap-4">
            ...
            <div className="bg-gray-100 p-4 rounded-md">
              ...
              <div className="h-24"></div> {/* Empty space for summary content */}
            </div>
          </div>
        </div>
      </div>
